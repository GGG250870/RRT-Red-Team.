...
- Agent operating model obbligatorio: [[02_AGENTS/RRT_AGENT_OPERATING_MODEL_V1]]
...
- Agent release readiness: A9 puo produrre `READY_FOR_HUMAN_REVIEW`, ma non `OPPORTUNITY_SIGNAL` o outreach approvato.
