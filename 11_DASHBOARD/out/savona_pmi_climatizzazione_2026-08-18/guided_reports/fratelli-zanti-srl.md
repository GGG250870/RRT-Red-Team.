# Passaggio 2 - RRT Guided Opportunity Report - Fratelli Zanti Srl
...
- Decision: ESCALATE
- Preliminary score: 74

## Contatti
- Telefono: +39 019 50 50 99
- Cellulare/WhatsApp: +39 335 7615199
- Email: zanti@zanti.it
- Indirizzo: Borgo Gramsci, 14 - 17014 Cairo Montenotte (SV)

## Opportunity Hypothesis
This is a working hypothesis from free public signals only. It must be confirmed before any commercial claim.
- Current next action: Pronto per selezione umana; A1-A9 resta bloccato finche non autorizzato.
- Strongest free signal bucket: financial_capacity_score
